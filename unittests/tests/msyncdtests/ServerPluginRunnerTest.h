...
#ifndef SERVERPLUGINRUNNERTEST_H
#define SERVERPLUGINRUNNERTEST_H
...
private slots:
    ...
    void testStartAbort();
    void testSyncResults();
    void testSignals();

private:
    ServerPluginRunner *iServerPluginRunner;
...
#endif // SERVERPLUGINRUNNERTEST_H
