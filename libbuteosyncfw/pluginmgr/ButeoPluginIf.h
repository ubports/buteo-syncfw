 ...
 * Command line was: qdbusxml2cpp -v -c ButeoPluginIf -p ButeoPluginIf.h:ButeoPluginIf.cpp com.buteo.msyncd.baseplugin.xml
 *
...
#ifndef BUTEOPLUGINIF_H_1382680026
#define BUTEOPLUGINIF_H_1382680026
 ...
 */
class ButeoPluginIf: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    ButeoPluginIf(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> cleanUp()
    {
        QList<QVariant> argumentList;
    ...
    inline QDBusPendingReply<> uninit()
    {
        QList<QVariant> argumentList;
...
namespace com {
  namespace buteo {
    namespace msyncd {
      typedef ::ButeoPluginIf baseplugin;
    }
  }
}
#endif
